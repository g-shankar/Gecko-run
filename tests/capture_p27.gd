extends SceneTree
## P27 screenshot capture: the pitch-deck HUD in a real run.
##
## Run: xvfb-run -a godot --path <project> --resolution 1280x720 \
##        --script res://tests/capture_p27.gd -- <out_dir> <shot_name>
##   or: xvfb-run -a godot --path <project> --resolution 720x1280 \
##        --script res://tests/capture_p27.gd -- <out_dir> <shot_name>
##
## Captures one settled gameplay shot with the full P27 HUD visible.

var _out_dir: String = "/tmp/p27_shots"
var _shot_name: String = "p27_run.png"
...
func _run() -> void:
	...
	var cap_profile := "user://cap_p27_profile.json"
